...
<div class="innerLR">
<form action="/senti/index" method="get"><input type="hidden" value="3" name="period" id="period" /><input type="hidden" value="" name="author" id="author" /><div class="row-fluid pb10">
  <div class="clearfix time-opt">   
    <ul class="inline tab-small">
      <li class="first ">
        <a href="/senti/index?period=1&amp;source=&amp;sentiment=&amp;topic_id=&amp;merge=1&amp;author=">今日</a>      </li>
      <li >
        <a href="/senti/index?period=2&amp;source=&amp;sentiment=&amp;topic_id=&amp;merge=1&amp;author=">昨日</a>      </li>
      <li class=current>
        <a href="/senti/index?period=3&amp;source=&amp;sentiment=&amp;topic_id=&amp;merge=1&amp;author=">7天</a>            
      </li>
      <li >
        <a href="/senti/index?period=4&amp;source=&amp;sentiment=&amp;topic_id=&amp;merge=1&amp;author=">30天</a> 
      </li>
      <li></li>
      <li>自定义：
      
      <input class="input-small" readonly="readonly" onchange="document.getElementById(&quot;period&quot;).value=&quot;&quot;; this.form.submit();" id="start_date" type="text" value="2014-08-06" name="start_date" />      <a class="i-cal" href="javascript:;" id="start_date_link"></a>
      <script>
        $(function(){
      ...
      <input class="input-small" readonly="readonly" onchange="document.getElementById(&quot;period&quot;).value=&quot;&quot;; this.form.submit();" id="end_date" type="text" value="2014-08-12" name="end_date" />      <a class="i-cal" href="javascript:;" id="end_date_link"></a>
      <script>
        $(function(){
...
<div class="row-fluid">
    <div class="span12">
      <div class="widget">
        <div class="widget-hd"><span class="fr"><a href="/senti/export?0=&period=3&source=&sentiment=&topic_id=&merge=1&start_date=&end_date=" class="i-export">导出</a></span>情感走势
          <label class="fr mr20" for="chartType2">
            <div class="ez-radio"><input type="radio" name="chart_type" 
          data-toggle="radio" class="ez-hide" id="chartType2"></div> 柱状图
          </label>

          <label class="fr mr20" for="chartType1">
            <div class="ez-radio"><input type="radio" name="chart_type" 
          data-toggle="radio" class="ez-hide" checked id="chartType1"></div> 线状图
          </label>
...
<script type="text/javascript" id="bdshare_js" data="type=tools&amp;uid=0" src="./js/dimensionAnalysis/sentimentTrend/bds_s_v2.js"></script>
