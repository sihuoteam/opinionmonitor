...
<form action="" method="get"><input type="hidden" value="" name="period" id="period"><input type="hidden" value="" name="author" id="author"><div class="row-fluid">
    <div class="clearfix time-opt">   
        ...
        <div class="row-fluid">
          <div class="export-option">
          <h2>数据字段</h2>
          <span id="field"><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="topic" id="field_0" checked="checked" type="checkbox" name="field[]"></div>话题</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="title" id="field_1" checked="checked" type="checkbox" name="field[]"></div>标题</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="summary" id="field_2" checked="checked" type="checkbox" name="field[]"></div>摘要</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="url" id="field_3" checked="checked" type="checkbox" name="field[]"></div>URL</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="click_count" id="field_4" checked="checked" type="checkbox" name="field[]"></div>点击数</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="comment_count" id="field_5" checked="checked" type="checkbox" name="field[]"></div>评论数</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="forward_count" id="field_6" checked="checked" type="checkbox" name="field[]"></div>转发数</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="author" id="field_7" checked="checked" type="checkbox" name="field[]"></div>作者</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="source" id="field_8" checked="checked" type="checkbox" name="field[]"></div>来源</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="media" id="field_9" checked="checked" type="checkbox" name="field[]"></div>媒体</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="region" id="field_10" checked="checked" type="checkbox" name="field[]"></div>地域</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="sentiment" id="field_11" checked="checked" type="checkbox" name="field[]"></div>情感</label><label><div class="ez-checkbox ez-checked"><input data-toggle="checkbox" class="ez-hide" value="pub_time" id="field_12" checked="checked" type="checkbox" name="field[]"></div>发布日期</label></span>          </div>
        </div>
         
        <div class="row-fluid">
          <div class="export-option">
          <h2>条数</h2>
          <span id="limit"><label><div class="ez-radio ez-selected"><input data-toggle="checkbox" class="ez-hide" value="100" id="limit_0" checked="checked" type="radio" name="limit"></div>前100条</label><label><div class="ez-radio"><input data-toggle="checkbox" class="ez-hide" value="500" id="limit_1" type="radio" name="limit"></div>前500条</label><label><div class="ez-radio"><input data-toggle="checkbox" class="ez-hide" value="1000条" id="limit_2" type="radio" name="limit"></div>前1000条</label><label><div class="ez-radio"><input data-toggle="checkbox" class="ez-hide" value="2000条" id="limit_3" type="radio" name="limit"></div>前2000条</label><label><div class="ez-radio"><input data-toggle="checkbox" class="ez-hide" value="20000条" id="limit_4" type="radio" name="limit"></div>前20000条（请不要重复提交，下载时间可能较长请耐心等待）</label></span>          </div>
        </div>
