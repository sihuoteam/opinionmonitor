...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/dimensionAnalysis/mediaSource/jquery-ui.css" />
<link rel="stylesheet" type="text/css" href="./css/dimensionAnalysis/mediaSource/styles.css" />
<link rel="stylesheet" type="text/css" href="./css/dimensionAnalysis/mediaSource/pager.css" />
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/jquery.js"></script>
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/jquery.yii.js"></script>
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/jquery.ba-bbq.js"></script>
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/highcharts.src.js"></script>
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/exporting.src.js"></script>
  </head>
...
<option value="982">性价比口碑</option>
 ...
 <div class="row-fluid">
      <div class="span12">
          <div class="widget">
              <div class="widget-hd"><span class="fr"><a href="http://yq.adt100.com/source/export?0=&period=3&source=&sentiment=&topic_id=&merge=1&start_date=&end_date=" class="i-export">导出</a></span>媒体来源
              </div> 
              <div class="widget-bd">
...
<script type="text/javascript" id="bdshare_js" data="type=tools&amp;uid=0" src="./js/dimensionAnalysis/mediaSource/bds_s_v2.js"></script>
...
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/pop.js"></script>
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/jquery.simInput.js"></script>
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/bootstrap-dropdown.js"></script>
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/common.js"></script>
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/my.js"></script>
...
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/jquery-ui.min.js"></script>
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/jquery-ui-i18n.min.js"></script>
<script type="text/javascript" src="./js/dimensionAnalysis/mediaSource/jquery.yiilistview.js"></script>
