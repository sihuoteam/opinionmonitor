...
import com.hhhy.crawler.www_ce_cn.Controller;
...
public class Tiimer extends TimerTask {
    com.hhhy.crawler.www_ce_cn.Controller controller;

    public Tiimer(com.hhhy.crawler.www_ce_cn.Controller controller) {
