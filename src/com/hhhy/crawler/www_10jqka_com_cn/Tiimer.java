...
import com.hhhy.crawler.finance_qq_com.Controller;
...
public class Tiimer extends TimerTask {
    com.hhhy.crawler.finance_qq_com.Controller controller;

    public Tiimer(com.hhhy.crawler.finance_qq_com.Controller controller) {
