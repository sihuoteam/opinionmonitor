...
import com.hhhy.crawler.www_stcn_com.Controller;
...
public class Tiimer extends TimerTask {
    com.hhhy.crawler.www_stcn_com.Controller controller;

    public Tiimer(com.hhhy.crawler.www_stcn_com.Controller controller) {
