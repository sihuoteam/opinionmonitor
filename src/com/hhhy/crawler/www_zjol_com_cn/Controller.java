...
public class Controller {
    ...
    private final String BASE_URL = "http://search.zjol.com.cn/";
   ...
   /* private static String lastTime;
    ...
    public static void parseBoard(String keyWord,String BASE_URL){
        ...
        String html = GetHTML.getHtml("http://search.zjol.com.cn/?q="+transKey+"&Submit=+&wseColumns=S1", "utf-8");
        ...
        搜索关键词是否存在
         */
        String flag = document.select("div#divDiss").select("div.divDis").text();
        if(flag.length()==0){
            //Todo ??
            System.out.println("nothing to found.....");
        }
        else{
            Elements tableEles = document.select("div#divDiss").select("div.divDis");
    ...
    public static void parsePages(ArrayList<Element> tableList){
        for(Element ele:tableList){
            ...
            if(!ContentFilter.redundant(spyHistory, title)){
                ...
                System.out.println("website:"+"浙江在线");
                System.out.println("----------------");
