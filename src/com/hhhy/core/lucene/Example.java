...
//        directory = new RAMDirectory();
        directory = new SimpleFSDirectory(new File("d:\\hbase"));
    ...
    private void addContent(IndexWriter iwriter, String text)
        ...
        // Field f = new Field("text", text, Field.Store.YES,
        // Field.Index.ANALYZED);
        // TextField表示需要对内容进行分词，StringField说明不分词
        Field f = new TextField("text", text, Field.Store.YES);
        doc.add(f);
